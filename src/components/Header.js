    ...
    <header className="w-full h-1/8 flex items-center justify-center">
      <div className="w-9/10 h-full flex justify-between items-center">
        <nav>
          ...
          >
            <img
              src="/logo_u_festival_dark_mode.png"
              alt="logo"
              width="30px"
              height="30px"
        ...
        <button
          ...
          className="size-16 rounded-2xl shadow-md/40 shadow-black flex justify-center items-center bg-black dark:bg-white dark:shadow-white"
